...
| **Column** | **Content** | **Cardinality** | **Example 1: UniProt protein**| **Example 2: Protein-coding gene (MOD)** | **Example 3: UniProt isoform**| **Example 4: protein complex** | **Example 5: ncRNA**
|----------|---------|-------------|---------|--------|
