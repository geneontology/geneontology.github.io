...
The GO-CAM model is further described in the Nat Genet. Sep 2019 [Gene Ontology Causal Activity Modeling (GO-CAM) moves beyond GO annotations to structured descriptions of biological functions and systems](https://rdcu.be/bRIgY){:target="blank"}
