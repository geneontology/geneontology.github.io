...
+ The **[Gene Ontology (GO)](/docs/ontology-documentation/)**, which provides the logical structure of the biological functions (‘terms’) and their relationships to one another, manifested as a directed acyclic graph; and 
