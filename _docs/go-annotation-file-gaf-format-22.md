...
* Cardinality = 1
  * For [**negation**](https://wiki.geneontology.org/Elements_of_an_annotation#Negation), a pipe must be used to separate the "NOT" from the relation (e.g. "NOT\|contributes_to" or "NOT\|enables").
