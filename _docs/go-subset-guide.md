...
- Alternatively, users and user communities can create their own GO subsets. Please email the [GO helpdesk](/docs/help/) for more information about creating and submitting your GO subsets.
