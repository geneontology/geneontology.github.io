...
[ [Try the GO SPARQL endpoint](https://geneontology.org/sparql){:target="blank"} ]
...
In addition of using OWL to describe ontologies, GO-CAMs rely on the [Relation Ontology (RO)](https://github.com/oborel/obo-relations/){:target="blank"} and [Basic Formal Ontology (BFO)](http://basic-formal-ontology.org/){:target="blank"} to describe the relations between genes, [molecular function, biological process and cellular component](/docs/ontology-documentation/). In the following example, the GO-CAM informs that the activity [sequence-specific DNA binding](https://amigo.geneontology.org/amigo/term/GO:0043565){:target="blank"} `enabled by` the [IRF3 Hsap](https://amigo.geneontology.org/amigo/gene_product/UniProtKB:Q14653){:target="blank"} gene `directly positively regulates` the [DNA-binding transcription activator activity](https://amigo.geneontology.org/amigo/term/GO:0003700){:target="blank"} of [IRF3 Hsap](https://amigo.geneontology.org/amigo/gene_product/UniProtKB:Q14653){:target="blank"}, and that both activities `occurs in` the [nucleus](https://amigo.geneontology.org/amigo/term/GO:0005634){:target="blank"}:

<p align="center">
  <img width="500" src="/assets/RO_example.png" alt="Example of use of the Relation Ontology in GO-CAMs">
</p>

In this other GO-CAM, one can read that the [DNA-binding transcription factor activity](https://amigo.geneontology.org/amigo/term/GO:0003700){:target="blank"} `enabled by` [zip-2 Cele](https://amigo.geneontology.org/amigo/gene_product/WB:WBGene00019327){:target="blank"} is `causally upstream of, positive effect` of two molecular activities: the [deaminase activity](https://amigo.geneontology.org/amigo/term/GO:0019239){:target="blank"} on the left and an unknown activity on the right generically called [Molecular function](https://amigo.geneontology.org/amigo/term/GO:0003674){:target="blank"} but which is `enabled by` [irg-2 Cele](https://amigo.geneontology.org/amigo/gene_product/WB:WBGene00016783){:target="blank"}. In addition, all those activities are described as being `part of` the [defense response to Gram-negative bacterium](https://amigo.geneontology.org/amigo/term/GO:0050829){:target="blank"} biological process.
