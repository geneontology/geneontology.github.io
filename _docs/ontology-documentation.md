...
## GO terms
GO terms are composed of a term name, a unique identifier, a definition, and several other elements. Elements of GO term are deescribed [here](/docs/ontology/). 
