...
|------------------|----------|
|GO slim AGR Developed by GO Consortium for the [Alliance of Genomes Resources](https://www.alliancegenome.org/) |[OBO format](http://current.geneontology.org/ontology/subsets/goslim_agr.obo)- [OWL format](http://current.geneontology.org/ontology/subsets/goslim_agr.owl) - [json format](http://current.geneontology.org/ontology/subsets/goslim_agr.json) - [yaml format(http://current.geneontology.org/ontology/subsets/goslim_agr.yaml)|
